(() => {
  ...
  function marineMenu() {
    return `<h4>Marine</h4>
      <a href="/marine.html">Marine Electronics</a><a href="/marine.html">Deck & Hardware</a><a href="/marine.html">Lighting</a>
      <a href="/marine.html">Anchoring & Mooring</a><a href="/marine.html">Safety & Navigation</a><a href="/marine.html">Boat Care & Maintenance</a>
      <a class="all" href="/marine.html">Shop All Marine →</a>`;
  }

  function ukMenu(label) {
    return `<h4>${label}</h4><a href="/shield-autocare-uk.html">Current UK range</a><a href="/uk-contact.html">Product & fitment help</a><a href="/uk-shipping-delivery-policy.html">Delivery information</a><a class="all" href="/shield-autocare-uk.html">Shop available products →</a>`;
  }
