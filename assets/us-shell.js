(() => {
  ...
  function brand() {
    return `<img class="ot-brand-logo-image" src="/assets/omni-terrain-logo-transparent.webp?v=1" alt="Omni Terrain" width="300" height="80" decoding="async" loading="eager" fetchpriority="high">`;
  }
  ...
  function injectCss() {
    ...
    ensureStyle('link[data-ot-brand-speed],link[href*="brand-speed.css"]', "/assets/brand-speed.css?v=13", "otBrandSpeed");
  }
