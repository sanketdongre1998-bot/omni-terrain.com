(() => {
  ...
  function brand() {
    return `<img class="ot-brand-logo-image" src="/assets/omni-terrain-logo-header.webp?v=3" alt="Omni Terrain" width="270" height="76" decoding="async" loading="eager" fetchpriority="high">`;
  }
  ...
  function injectCss() {
    ...
    ensureStyle('link[data-ot-brand-speed],link[href*="brand-speed.css"]', "/assets/brand-speed.css?v=14", "otBrandSpeed");
  }
