...
function scripts() {
  return `<script src="assets/shield-products.js"></script><script src="assets/uk-commerce.js"></script><script src="assets/shield-catalogue.js"></script><script defer src="assets/theme-toggle.js?v=8"></script></body></html>`;
}
