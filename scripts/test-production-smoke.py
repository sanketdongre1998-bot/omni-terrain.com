...
def main() -> int:
    ...
    need("assets/growth-marketing.js", "Featured shipping savings", "customer-facing deal savings")
    need("assets/live-storefront-priority.js", "Product + delivery", "homepage offer value breakdown")
    need("assets/us-live-commerce.js", "Your delivery discount", "product-page discount breakdown")
    need("assets/us-live-commerce.js", "shippingQuoteUSD", "registry-backed delivery value")
